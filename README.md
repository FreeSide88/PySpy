...
In addition, PySpy uses a proprietary database which creates summary statistics. Now database has been collected since the beginning of 2022. Can be extended further if requested.

If you enjoy using PySpy and would like to show your appreciation, please feel free to send ISK in-game to Hren Shi. Thank you.
